...
- **77種類のセクションコンポーネント**（Hero / Features / Pricing / Testimonials / CTA / FAQ ほか14カテゴリ）
- **3つのデザイン様式**: スタンダード（グローバル・ミニマル）/ **日本型・高密度**（PASONA構成・CTA反復・注釈対応のコンバージョン特化縦長LP）/ **リッチ表現**（大型タイポグラフィ・エディトリアルレイアウトのアワード志向デザイン）
